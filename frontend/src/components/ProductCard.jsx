    ...
    >
      <div className="w-full h-[150px] md:h-[200px] flex items-center justify-center mb-4 relative pointer-events-none">
        ...
        <button
          ...
          className="absolute top-2 right-2 p-1.5 rounded-full bg-white/80 hover:bg-white shadow-sm pointer-events-auto transition-transform active:scale-90 z-20"
        >
